                ...
                <tbody>
                 <c:forEach var="Rides" items="${Rides}">
                    <tr>
                        ...
                        <td>
                            <a href="RideOutsList?id=<c:out value='${Rides.id}' />" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="RideOutDelete?id=<c:out value='${Rides.id}' />" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
